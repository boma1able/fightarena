                    ...
                    @forelse($inventory as $item)
                        ...
                        <div id="item-{{ $item->id }}" class="flex odd:bg-[#f9f9f9] group transition-w duration-300 mb-[3px]">
                            ...
                            <div class="w-full flex flex-col p-2">
                                <h3 class="font-semibold mb-1">{{ __('items.' . $item->key . '.name') }} [{{ $item->required_level }}]</h3>
                                ...
                                <p class="mt-2 text-[14px] min-h-[65px] font-thin italic">{{ __('items.' . $item->key . '.description') }}</p>
                                <div class="flex flex-wrap items-center justify-start gap-[12px] mt-2">
                                    <button wire:click="selectForRepair({{ $item->pivot->id }})" class="px-3 py-1 text-white bg-blue-500 text-black">{{ __('messages.repair') }}</button>
                                </div>
                            </div>
                        </div>
                    @empty
