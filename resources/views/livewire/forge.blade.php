<div class="bg-white p-6 rounded shadow-md">
    ...
    @if($character)
        <div class="flex mb-4 w-full gap-5">
            ...
            {{-- <div class="w-1/3">
                <img src="{{ asset('images/blacksmith.png') }}" alt="" class="transform scale-x-[-1]">
            </div> --}}

             {{-- Ліва панель ремонту --}}
            <div class="forge flex w-[50%] h-[700px] bg-gray-50 p-4 shadow items-center justify-center"
                style="background: url({{ asset('images/blacksmith.jpg') }}) right center no-repeat; background-size: cover;"
            >
                <div>
