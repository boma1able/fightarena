                ...
                <div class="flex flex-col w-full max-w-[362px]">
                    <div class="flex">
                        ...
                        <div class="w-[205px] h-full mx-[10px]">
                            ...
                            <div class="avatar w-[205px] h-[410px]" style="background: url({{ asset('images/avatar-' . $character->user->gender . '-art.jpg') }}) center center no-repeat; background-size: cover;" title="{{ $character->user->name }} [{{ $character->level }}]"></div>
